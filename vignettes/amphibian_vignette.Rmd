...
```{r}
A.deli_overlap.null <- overlap_null_distrib(A.delicatus, A.delicatus_ecoregion, rand_both = F, x_cat = T, n_iterations = 100, projection = 4210, x_model = 'random_cluster', progress = F)
```
