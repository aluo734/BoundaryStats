...
```{r}
A.deli_bound.null <- boundary_null_distrib(A.delicatus, cat = T, n_iterations = 5, projection = 4210, model = 'random_cluster', progress = F)
```
...
```{r}
A.deli_overlap.null <- overlap_null_distrib(A.delicatus, A.delicatus_ecoregion, x_cat = T, y_cat = T, n_iterations = 5, projection = 4210, x_model = 'random_cluster', y_model = 'random_cluster', progress = F)
```
