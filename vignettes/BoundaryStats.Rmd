...
```{r}
L.flav_bound.null <- boundary_null_distrib(L.flavomaculatus, cat = T, n_iterations = 50, model = 'random_cluster', p = 0.5, progress = F)
```
...
```{r}
L.flav_overlap.null <- overlap_null_distrib(L.flavomaculatus, ecoregions, rand_both = F, x_cat = T, n_iterations = 50, x_model = 'random_cluster', px = 0.5, progress = F)
```
